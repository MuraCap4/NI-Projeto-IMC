...
public class Obesidade3Activity extends AppCompatActivity {
    ...
    //Instanciamento
    private Button btnT8Reset;
    private TextView textT8Resultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Definindo
        textT8Resultado = findViewById(R.id.textT8Resultado);
        btnT8Reset = findViewById(R.id.btnT8Fechar);
        ...
        //Mostrando resultado
        textT8Resultado.setText(resultado);

        //Voltando a pagina inicial e dando destroy
        btnT8Reset.setOnClickListener(view -> {
