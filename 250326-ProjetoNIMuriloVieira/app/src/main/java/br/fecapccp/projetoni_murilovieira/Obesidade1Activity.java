...
public class Obesidade1Activity extends AppCompatActivity {
    //Intanciamento
    private Button btnT6Reset;
    private TextView textT6Resultado;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Definindo
        textT6Resultado = findViewById(R.id.textT6Resultado);
        btnT6Reset = findViewById(R.id.btnT6Fechar);
        ...
        //Mostrando resultado
        textT6Resultado.setText(resultado);

        //Voltando a pagina inicial e dando Destroy
        btnT6Reset.setOnClickListener(view -> {
